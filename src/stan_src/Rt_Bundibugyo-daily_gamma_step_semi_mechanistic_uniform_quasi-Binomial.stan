...
generated quantities {
    ...
    // Weekly quantities run to W + 3 (three trailing zero weeks); p_asc = 1 there, so they add no missed cases.
    array[W + 3] int missed_cases;         // sampled missed cases by week
    array[W + 3] int cases_true;           // observed + missed, by week
    int total_missed_cases;                // sum of sampled missed cases
    int total_true_cases;                  // observed + total missed
    vector[W + 3] expected_missed_cases;   // mean missed cases (for reference)
    vector[W + 3] case_pred_mean;          // p_asc * E[c_x]: predicted reported-case mean
    array[W + 3] int case_pred;            // posterior predictive reported cases
