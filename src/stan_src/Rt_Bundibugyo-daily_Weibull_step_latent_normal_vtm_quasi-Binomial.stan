...
// Daily state-space renewal model, Weibull incubation period: latent daily infections with variance-to-mean (VTM)
...
data {
    ...
    real<lower = 0> mean_inc, param1_Weibull_inc, mean_ost, sd_ost;
}
